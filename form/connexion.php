...
<body>
  ...
  <form class="form-container" method="post" action="../traite/traitementconnexion.php">
    ...
    <a href="resetPassword.php">
      <p class="form-footer">Mot de passe oublier?
    </a></p>
    <div class="form-checkbox">
    </div>
    <div id="login-message"></div>
    <button class="form-button" type="submit">Se connecter</button>
    <p class="form-footer">Je n'ai pas de compte? <a href="login.php">S'inscrire</a>.</p>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('form').submit(function(event) {
        ...
        $.ajax({
          type: 'POST',
          url: '../traite/traitementconnexion.php',
          data: formData,
