...
$selectQuery = "SELECT h.hopitalname, b.blood_type FROM hopital h INNER JOIN blood_stock b ON h.id = b.user_id WHERE b.blood_type = 'AB+'";
...
if ($result->num_rows > 0) {
    ...
    echo "Aucun hôpital avec le groupe sanguin AB+ trouvé.";
}
