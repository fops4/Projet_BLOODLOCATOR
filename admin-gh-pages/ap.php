...
$selectQuery = "SELECT h.hopitalname, b.blood_type FROM hopital h INNER JOIN blood_stock b ON h.id = b.user_id WHERE b.blood_type = 'A+'";
...
echo "<table>";
    ...
    echo "Aucun hôpital avec le groupe sanguin A+ trouvé.";
}
